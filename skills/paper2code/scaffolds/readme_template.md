...
Implementation of [{{PAPER_TITLE}}]({{PAPER_URL}}) ({{AUTHORS}}, {{YEAR}}).
...
*Generated by [paper2code](https://github.com/pikabell/paper2code) — citation-anchored paper implementation.*
